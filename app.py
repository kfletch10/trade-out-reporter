...
def clean_rent_value(value):
    """Clean and convert rent values, handling special cases like asterisk"""
...
def main():
    ...
    if st.session_state.trade_out_data is not None:
        ...
        ### 🧠 Smart Features:
        - **Intelligent header detection** - Finds data rows automatically
        - **Smart column matching** - Detects Unit, Rent, Status columns
        - **Data quality handling** - Handles "*", "N/A", and formatting issues
        - **Manual override** - Select columns manually if auto-detection fails
